...
(function (window) {
  ...
  stepsForm.prototype._init = function () {
    ...
    for (var i = this.questions.length - 1; i >= 0; i--) {
      var formElement = this.questions[i].querySelector("input, text, select");
  ...
  stepsForm.prototype._initEvents = function () {
    var self = this,
      // first input
      firstElInput = this.questions[this.current].querySelector(
        "input, text, select"
      ),
      // focus
  ...
  stepsForm.prototype._nextQuestion = function () {
    ...
    if (this.supportsHTML5Forms) {
      var input = this.questions[this.current].querySelector(
        "input, text, select"
      );
    ...
    var self = this,
      onEndTransitionFn = function (ev) {
        ...
        if (self.isFilled) {
          ...
          nextQuestion.querySelector("input, text, select").focus();
        }
      };
